...
with open('expired_orders.txt', 'w') as f:
    for i in range(20):
        ...
        date = str(datetime.datetime(2020, 1, 3 + i))[:10]
        # print(date)
        f.write("INSERT INTO order_primary_info VALUES(DEFAULT, {}, '{}', '{}', '{}', {}, True, {}, '{}', current_date - {});\n".format(i + 1, delivery[random.randint(0, 2)], where_from, client_city[i+1],
        b[random.randint(0, 1)], is_international, date,  i * 13))
